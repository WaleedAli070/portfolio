...
export const COMPANY_PROJECTS: Project[] = [
  {
    ...
    tags: ['AWS CDK', 'Nest.js', 'Temporal'],
    summary: [
      'Round unifies treasury, payments, FX, and reconciliation for finance teams. I joined as Staff Engineer in Oct 2024, starting with infrastructure and moving into the core financial systems.',
      'First I paid down infrastructure risk — migrating to a modular AWS CDK environment, hardening security, and speeding up CI/CD. Since then I have been building the banking side: integrations and durable financial workflows on Nest.js + Temporal.',
    ],
    highlights: [
      'Orchestrated migration from legacy infra to modular AWS CDK, cutting cloud overhead',
      'Hardened infra security and CI/CD — pipeline time down from 20+ min to ~14 min',
      'Building banking integrations and core financial workflows (Nest.js + Temporal)',
      'Set up the OTel pipeline via ADOT for Temporal workers + backend, monitored in CloudWatch',
      'Resolved all infrastructure findings for ISO 27001:2022 certification',
      'Tracked down a Temporal worker memory issue in a legacy workflow (write-up coming)',
    ],
    stack: ['TypeScript', 'Nest.js', 'Temporal', 'AWS CDK', 'OpenTelemetry', 'CloudWatch'],
  },
  {
    id: 'sohookd',
    name: 'SoHookd',
